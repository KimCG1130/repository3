...
function fncGetProductList(){
	document.detailForm.submit();//방금수정 이상생기면 주석처리
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		<td colspan="11" ><%= total%> 건수, 현재 <%=currentPage %> 페이지</td>
	</tr>
	<tr>
	...
	<tr class="ct_list_pop">
		...
		<td></td>
		<td align="left">
			<a href="/getProduct.do?prodNo=<%=vo.getProdNo() %>"><%= vo.getProdName() %></a><!-- 수정 및 검색 -->
		</td>
		<td></td>
